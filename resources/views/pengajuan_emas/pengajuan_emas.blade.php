            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">List Pengajuan emas</span>
                        {{-- <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 400+ new members</span> --}}
                    </h3>
                    @if (Auth::guard('nasabah')->check() == true)
                        <a href="/pengajuan_emas/input"> <button class="btn btn-primary"> Pengajuan Emas</button></a>
                    @endif
                                        ...
                                        @foreach ($data as $pengajuanEmas)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $pengajuanEmas->getHargaEmas->harga_emas }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $pengajuanEmas->nominal_pengajuan }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $pengajuanEmas->berat_emas }}
                                                        (per gram)
                                                    </span>
                                                </td>
                                                <td class="text-center">

                                                    @if ($pengajuanEmas->status == null || $pengajuanEmas->status == 0)
                                                        <span
                                                            class="badge badge-pill badge-primary font-weight-bolder font-size-lg">
                                                            Proses
                                                        </span>
                                                    @elseif ($pengajuanEmas->status == 1)
                                                        <span
                                                ...
                                                <td class="text-center pr-0">
                                                    @if (Auth::guard('admin')->check() == true)
                                                        <a href="/pengajuan_emas/edit/{{ $pengajuanEmas->id }}"
                                                        ...
                                                        <a href="/pengajuan_emas_approve/edit/{{ $pengajuanEmas->id }}"
                                                            class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3"
                                                            title="approve">
                                                            <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg-->
