...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable" data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="" data-scrolltop="on">
  <!--begin::Main-->
  <!--begin::Header Mobile-->
    ...
    <div class="d-flex flex-row flex-column-fluid page">
      ...
      <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
        ...
        <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
          ...
          <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 824px; overflow: hidden;">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
            ...
            <div class="ps__rail-y" style="top: 0px; height: 824px; right: 4px;">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
              ...
              <div class="d-flex align-items-center">
                ...
                <a href="#" class="btn btn-sm btn-light font-weight-bold mr-2" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="" data-placement="left" data-original-title="Select dashboard daterange">
                  ...
                  <span class="text-primary font-size-base font-weight-bolder" id="kt_dashboard_daterangepicker_date">Mar 5</span>
                </a>
                <!--end::Daterange-->
                <!--begin::Dropdowns-->
                  ...
                  <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                    ...
                    <div class="card-body p-0 position-relative overflow-hidden">
                      ...
                      <div id="kt_mixed_widget_1_chart" class="card-rounded-bottom bg-danger" style="height: 200px; min-height: 200px;">
                        <div id="apexchartsujqvl0vf" class="apexcharts-canvas apexchartsujqvl0vf apexcharts-theme-light" style="width: 343px; height: 200px;"><svg id="SvgjsSvg1166" width="343" height="200" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" class="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;">
                            <g id="SvgjsG1168" class="apexcharts-inner apexcharts-graphical" transform="translate(0, 0)">
                              <defs id="SvgjsDefs1167">
                                <clipPath id="gridRectMaskujqvl0vf">
                                  <rect id="SvgjsRect1171" width="350" height="203" x="-3.5" y="-1.5" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
                                </clipPath>
                                <clipPath id="gridRectMarkerMaskujqvl0vf">
                                  <rect id="SvgjsRect1172" width="347" height="204" x="-2" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect>
                                </clipPath>
                                <filter id="SvgjsFilter1178" filterUnits="userSpaceOnUse" width="200%" height="200%" x="-50%" y="-50%">
                                  <feFlood id="SvgjsFeFlood1179" flood-color="#d13647" flood-opacity="0.5" result="SvgjsFeFlood1179Out" in="SourceGraphic"></feFlood>
                                  <feComposite id="SvgjsFeComposite1180" in="SvgjsFeFlood1179Out" in2="SourceAlpha" operator="in" result="SvgjsFeComposite1180Out"></feComposite>
                                  <feOffset id="SvgjsFeOffset1181" dx="0" dy="5" result="SvgjsFeOffset1181Out" in="SvgjsFeComposite1180Out"></feOffset>
                                  <feGaussianBlur id="SvgjsFeGaussianBlur1182" stdDeviation="3 " result="SvgjsFeGaussianBlur1182Out" in="SvgjsFeOffset1181Out"></feGaussianBlur>
                                  <feMerge id="SvgjsFeMerge1183" result="SvgjsFeMerge1183Out" in="SourceGraphic">
                                    <feMergeNode id="SvgjsFeMergeNode1184" in="SvgjsFeGaussianBlur1182Out"></feMergeNode>
                                    <feMergeNode id="SvgjsFeMergeNode1185" in="[object Arguments]"></feMergeNode>
                                  </feMerge>
                                  <feBlend id="SvgjsFeBlend1186" in="SourceGraphic" in2="SvgjsFeMerge1183Out" mode="normal" result="SvgjsFeBlend1186Out"></feBlend>
                                </filter>
                                <filter id="SvgjsFilter1188" filterUnits="userSpaceOnUse" width="200%" height="200%" x="-50%" y="-50%">
                                  <feFlood id="SvgjsFeFlood1189" flood-color="#d13647" flood-opacity="0.5" result="SvgjsFeFlood1189Out" in="SourceGraphic"></feFlood>
                                  <feComposite id="SvgjsFeComposite1190" in="SvgjsFeFlood1189Out" in2="SourceAlpha" operator="in" result="SvgjsFeComposite1190Out"></feComposite>
                                  <feOffset id="SvgjsFeOffset1191" dx="0" dy="5" result="SvgjsFeOffset1191Out" in="SvgjsFeComposite1190Out"></feOffset>
                                  <feGaussianBlur id="SvgjsFeGaussianBlur1192" stdDeviation="3 " result="SvgjsFeGaussianBlur1192Out" in="SvgjsFeOffset1191Out"></feGaussianBlur>
                                  <feMerge id="SvgjsFeMerge1193" result="SvgjsFeMerge1193Out" in="SourceGraphic">
                                    <feMergeNode id="SvgjsFeMergeNode1194" in="SvgjsFeGaussianBlur1192Out"></feMergeNode>
                                    <feMergeNode id="SvgjsFeMergeNode1195" in="[object Arguments]"></feMergeNode>
                                  </feMerge>
                                  <feBlend id="SvgjsFeBlend1196" in="SourceGraphic" in2="SvgjsFeMerge1193Out" mode="normal" result="SvgjsFeBlend1196Out"></feBlend>
                                </filter>
                              </defs>
                              <g id="SvgjsG1197" class="apexcharts-xaxis" transform="translate(0, 0)">
                                <g id="SvgjsG1198" class="apexcharts-xaxis-texts-g" transform="translate(0, -4)"></g>
                              </g>
                              <g id="SvgjsG1207" class="apexcharts-grid">
                                <g id="SvgjsG1208" class="apexcharts-gridlines-horizontal" style="display: none;">
                                  <line id="SvgjsLine1210" x1="0" y1="0" x2="343" y2="0" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1211" x1="0" y1="20" x2="343" y2="20" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1212" x1="0" y1="40" x2="343" y2="40" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1213" x1="0" y1="60" x2="343" y2="60" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1214" x1="0" y1="80" x2="343" y2="80" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1215" x1="0" y1="100" x2="343" y2="100" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1216" x1="0" y1="120" x2="343" y2="120" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1217" x1="0" y1="140" x2="343" y2="140" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1218" x1="0" y1="160" x2="343" y2="160" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1219" x1="0" y1="180" x2="343" y2="180" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                  <line id="SvgjsLine1220" x1="0" y1="200" x2="343" y2="200" stroke="#e0e0e0" stroke-dasharray="0" class="apexcharts-gridline"></line>
                                </g>
                                <g id="SvgjsG1209" class="apexcharts-gridlines-vertical" style="display: none;"></g>
                                <line id="SvgjsLine1222" x1="0" y1="200" x2="343" y2="200" stroke="transparent" stroke-dasharray="0"></line>
                                <line id="SvgjsLine1221" x1="0" y1="1" x2="0" y2="200" stroke="transparent" stroke-dasharray="0"></line>
                              </g>
                              <g id="SvgjsG1173" class="apexcharts-area-series apexcharts-plot-series">
                                <g id="SvgjsG1174" class="apexcharts-series" seriesName="NetxProfit" data:longestSeries="true" rel="1" data:realIndex="0">
                                  <path id="SvgjsPath1177" d="M 0 200L 0 125C 20.008333333333333 125 37.15833333333333 87.5 57.166666666666664 87.5C 77.175 87.5 94.32499999999999 120 114.33333333333333 120C 134.34166666666667 120 151.49166666666667 25 171.5 25C 191.50833333333333 25 208.65833333333333 100 228.66666666666666 100C 248.67499999999998 100 265.825 100 285.8333333333333 100C 305.84166666666664 100 322.9916666666667 100 343 100C 343 100 343 100 343 200M 343 100z" fill="transparent" fill-opacity="1" stroke-opacity="1" stroke-linecap="butt" stroke-width="0" stroke-dasharray="0" class="apexcharts-area" index="0" clip-path="url(#gridRectMaskujqvl0vf)" filter="url(#SvgjsFilter1178)" pathTo="M 0 200L 0 125C 20.008333333333333 125 37.15833333333333 87.5 57.166666666666664 87.5C 77.175 87.5 94.32499999999999 120 114.33333333333333 120C 134.34166666666667 120 151.49166666666667 25 171.5 25C 191.50833333333333 25 208.65833333333333 100 228.66666666666666 100C 248.67499999999998 100 265.825 100 285.8333333333333 100C 305.84166666666664 100 322.9916666666667 100 343 100C 343 100 343 100 343 200M 343 100z" pathFrom="M -1 200L -1 200L 57.166666666666664 200L 114.33333333333333 200L 171.5 200L 228.66666666666666 200L 285.8333333333333 200L 343 200"></path>
                                  <path id="SvgjsPath1187" d="M 0 125C 20.008333333333333 125 37.15833333333333 87.5 57.166666666666664 87.5C 77.175 87.5 94.32499999999999 120 114.33333333333333 120C 134.34166666666667 120 151.49166666666667 25 171.5 25C 191.50833333333333 25 208.65833333333333 100 228.66666666666666 100C 248.67499999999998 100 265.825 100 285.8333333333333 100C 305.84166666666664 100 322.9916666666667 100 343 100" fill="none" fill-opacity="1" stroke="#d13647" stroke-opacity="1" stroke-linecap="butt" stroke-width="3" stroke-dasharray="0" class="apexcharts-area" index="0" clip-path="url(#gridRectMaskujqvl0vf)" filter="url(#SvgjsFilter1188)" pathTo="M 0 125C 20.008333333333333 125 37.15833333333333 87.5 57.166666666666664 87.5C 77.175 87.5 94.32499999999999 120 114.33333333333333 120C 134.34166666666667 120 151.49166666666667 25 171.5 25C 191.50833333333333 25 208.65833333333333 100 228.66666666666666 100C 248.67499999999998 100 265.825 100 285.8333333333333 100C 305.84166666666664 100 322.9916666666667 100 343 100" pathFrom="M -1 200L -1 200L 57.166666666666664 200L 114.33333333333333 200L 171.5 200L 228.66666666666666 200L 285.8333333333333 200L 343 200"></path>
                                  <g id="SvgjsG1175" class="apexcharts-series-markers-wrap" data:realIndex="0">
                                    <g class="apexcharts-series-markers">
                                      <circle id="SvgjsCircle1228" r="0" cx="0" cy="0" class="apexcharts-marker wz8hz0wel no-pointer-events" stroke="#d13647" fill="#ffe2e5" fill-opacity="1" stroke-width="3" stroke-opacity="0.9" default-marker-size="0"></circle>
                                    </g>
                                  </g>
                                </g>
                                <g id="SvgjsG1176" class="apexcharts-datalabels" data:realIndex="0"></g>
                              </g>
                              <line id="SvgjsLine1223" x1="0" y1="0" x2="343" y2="0" stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1" class="apexcharts-ycrosshairs"></line>
                              <line id="SvgjsLine1224" x1="0" y1="0" x2="343" y2="0" stroke-dasharray="0" stroke-width="0" class="apexcharts-ycrosshairs-hidden"></line>
                            ...
                            <g id="SvgjsG1206" class="apexcharts-yaxis" rel="0" transform="translate(-18, 0)"></g>
                      ...
                      <div class="resize-triggers">
                        <div class="expand-trigger">
                          <div style="width: 344px; height: 494px;"></div>
                        </div>
                          ...
                          <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover">
                              ...
                              <li class="navi-item">
                                ...
                                <div><a href��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������="" <div="" class="d-flex align-items-center">
                                  </a><a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Brad Simmons</a>
  ...
  <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <!--end::Header-->
    <!--begin::Content-->
    <div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 809px; overflow: hidden;">
      <!--begin::Header-->
      ...
      <div class="ps__rail-y" style="top: 0px; height: 809px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 300px;"></div>
      </div>
    </div>
    <!--end::Content-->
  ...
  <div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content">
      <!--begin::Wrapper-->
      <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps" style="height: 673px; overflow: hidden;">
        <!--begin::Item-->
  ...
  <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
    ...
    <div class="offcanvas-content px-10">
      <div class="tab-content">
        <!--begin::Tabpane-->
        <div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y" id="kt_quick_panel_logs" role="tabpanel" style="height: 805px; overflow: hidden;">
          <!--begin::Section-->
          <div class="mb-15">
          ...
          <div class="ps__rail-y" style="top: 0px; height: 805px; right: 0px;">
            <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 300px;"></div>
          </div>
        </div>
        <!--end::Tabpane-->
        <!--begin::Tabpane-->
        <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications" role="tabpanel" style="height: 805px; overflow: hidden;">
          <!--begin::Nav-->
        ...
        <!--end::Tabpane-->
        <!--begin::Tabpane-->
        <div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="kt_quick_panel_settings" role="tabpanel" style="height: 805px; overflow: hidden;">
          <form class="form">
            <!--begin::Section-->
            <div>
  ...
  <div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content">
      <!--begin::Wrapper-->
      <div class="offcanvas-wrapper mb-5 scroll-pull scroll ps ps--active-y" style="height: 748px; overflow: hidden;">
        ...
        <div class="ps__rail-y" style="top: 0px; height: 748px; right: -2px;">
          <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 62px;"></div>
        </div>
      </div>
      <!--end::Wrapper-->
      <!--begin::Purchase-->
  ...
  <svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;">
    ...
    <path id="SvgjsPath1004" d="M-1 150L-1 150C-1 150 68.83333333333333 150 68.83333333333333 150C68.83333333333333 150 137.66666666666666 150 137.66666666666666 150C137.66666666666666 150 206.5 150 206.5 150C206.5 150 275.3333333333333 150 275.3333333333333 150C275.3333333333333 150 344.16666666666663 150 344.16666666666663 150C344.16666666666663 150 413 150 413 150C413 150 413 150 413 150 "></path>
  </svg>
  <div class="daterangepicker ltr show-ranges opensleft">
    ...
    <div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-light-primary" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div>
  </div>
</body>
<!--end::Body-->
